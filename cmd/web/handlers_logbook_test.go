...
func TestHandlerFlightRecordsData(t *testing.T) {
	...
	assert.Equal(t, string(responseBody), `{"data":[["uuid","01/02/2022","LKPR","1000","EDDM","1200","C152","OK-XXX","2:00","","2:00","2:00","Self","1","2","2:00","2:00","2:00","2:00","2:00","2:00","SIM","2:00","Remarks"]]}`)
