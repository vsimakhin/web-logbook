  ...
  return (
    <>
      <TextField gsize={{ xs: 6, sm: 2, md: 2, lg: 2, xl: 2 }}
        id={`${type}.place`}
        label={<Label icon={icon} text={fieldName(type == "departure" ? "dep_place" : "arr_place", "flightRecord")} />}
      ...
      <TextField gsize={{ xs: 6, sm: 2, md: 2, lg: 2, xl: 2 }}
        id={`${type}.time`}
        label={<Label icon={icon} text={fieldName(type == "departure" ? "dep_time" : "arr_time", "flightRecord")} />}
        handleChange={handleChange}
